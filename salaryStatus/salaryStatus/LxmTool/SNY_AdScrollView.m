...
-(void)initScrollView
{
    ...
    _pageControl.currentPageIndicatorTintColor = MineColor;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    LxmResourceBannerModel * m =  [_dataArr objectAtIndex:indexPath.row];
    cell.img = [LxmURLDefine getPicImgWthPicStr:m.picUrl];
    return cell;
}
